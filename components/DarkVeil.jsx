  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uHueShift: { value: paramsRef.current.hueShift },
        uNoise: { value: paramsRef.current.noiseIntensity },
        uScan: { value: paramsRef.current.scanlineIntensity },
        uScanFreq: { value: paramsRef.current.scanlineFrequency },
        uWarp: { value: paramsRef.current.warpAmount },
      },
    });
    ...
    const resize = () => {
      ...
      const { resolutionScale: scale } = paramsRef.current;
